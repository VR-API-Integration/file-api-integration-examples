...
:note: The first time you execute the script, it will ask for your credentials and will save them securely in your computer, in the path specified in the configuration.  
